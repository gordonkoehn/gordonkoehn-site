...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
  ...
  <body role="document">
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
           <ul class="nav navbar-nav">
            <li class="active"><a href="#"><img src="img/google_analytics.png" class="img-rounded"></a></li>
            <li><a href="#about"><img src="img/phpmyadmin.png" class="img-rounded"></a></li>
            <li><a href="#contact"><img src="img/unity.jpg" class="img-rounded"></a></li>
             <li><a href="#contact"><img src="img/Play_Store_icon.png" class="img-rounded"></a></li>
    ...
    <div class="container theme-showcase" role="main">
      ...
      <div class="jumbotron">
        <h1 class = "text-center">I'm fine.</h1>
